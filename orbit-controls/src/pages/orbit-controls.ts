...
// // *Auto rotates the camera*
// controls.autoRotate = true;
// controls.autoRotateSpeed = 10

// // *Slows the camera before stopping*
// controls.enableDamping = true;
// controls.dampingFactor = 0.01;

// // *Allows for position movement of camera using custom controls*
...
// // *Affects how panning is handled*
// controls.screenSpacePanning = true

// // *Controls the extent to which the camera can be orbited*
