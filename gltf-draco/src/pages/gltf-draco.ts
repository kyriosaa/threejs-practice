...
// glTFLoader.load("models/michelle$@sneak_compressed.glb", (gltf) => {
...
async function loadMichelle() {
  const [michelle, idle, run, jump, pose] = await Promise.all([
    glTFLoader.loadAsync("models/michelle$@sneak_compressed.glb"),
    glTFLoader.loadAsync("models/michelle@idle.glb"),
    glTFLoader.loadAsync("models/michelle@run.glb"),
    glTFLoader.loadAsync("models/michelle@jump.glb"),
    glTFLoader.loadAsync("models/michelle@pose.glb"),
  ]);
